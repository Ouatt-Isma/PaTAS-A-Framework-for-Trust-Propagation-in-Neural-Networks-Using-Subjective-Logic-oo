...
Let a neural network be trained until convergence, and let its associated PaTAS operate with a stable input trust assessment $T_x$, a stable label trust assessment $T_y$, and a stable hyperparameter $\epsilon$.
